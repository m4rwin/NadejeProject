...
namespace Nadeje
{
	...
	{
		new Human() { ID = 1, FirstName = "Martin", LastName = "Hromek", BirthYear = 1986, Genre = true, ServicesForForeigners = true,
		...
		new Human() { ID = 00002, FirstName = "Johnny", LastName = "Rambo", BirthYear = 1952, Genre = true, ServicesForForeigners = false },
		new Human() { ID = 00003, FirstName = "Eva", LastName = "Březovská", BirthYear = 1989, Genre = false, ServicesForForeigners = false }
	};
